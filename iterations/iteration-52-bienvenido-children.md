# Iteration 52 — Bienvenido & Aurea's Children (Adrian's Generation)

**Time:** 2026-03-31 20:03 CDT
**Source:** Adrian confirmed + Ancestry search

## Bienvenido & Aurea's 5 Children (confirmed by Adrian)

1. **Encarnita Fernandez** — Adrian's aunt
   - Full name on Ancestry: **Encarnita Adela Abalos Fernandez** (also "Ethadel Fernandez")
   - "Adela" = middle name, "Abalos" = mother's maiden name
   - Found in US records (collection 61196)

2. **Vivienne Fernandez** — Adrian's aunt
   - **Vivienne A Fernandez** — TWO marriage records in **Miami-Dade, Florida** (collection 8784)
   - "A" = Abalos (mother's maiden name)
   - May currently live in Florida

3. **Michelle Fernandez** — Adrian's aunt (no Ancestry records found yet)

4. **Jocelyn Fernandez** — Adrian's aunt (common name, hard to match without more details)

5. **Raul Fernandez** — Adrian's father
   - Married Janice Cervantes (from Angeles City, Pampanga)
   - Currently lives in Allen, Texas area

## Children's Names — Filipino Naming Pattern
All 5 children likely follow: [First Name] [Middle Name] [Abalos] [Fernandez]
- Encarnita Adela Abalos Fernandez
- Vivienne A(balos) Fernandez
- Michelle A(balos) Fernandez
- Jocelyn A(balos) Fernandez  
- Raul A(balos) Fernandez

## Updated Family Count
